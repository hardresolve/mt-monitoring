...
export default function HeadTeacherDashboard() {
  ...
  async function loadData() {
    ...
    if (!prof || prof.role !== 'head_teacher') {
      router.push('/login')
      return
    }
          ...
          <div style={{
            ...
            <div>
              <h2 style={{ fontSize: '15px', fontWeight: 700, color: '#111827', marginBottom: '2px' }}>
                {profile?.subject_area || 'Department'} — Master Teacher Overview
              </h2>
          ...
          <>
            {masterTeachers.length === 0 ? (
              <div style={{
                ...
                <p style={{ fontSize: '14px', color: '#9ca3af' }}>No master teachers found in your department yet.</p>
              </div>
            ) : (
              <div style={{
                display: 'grid',
